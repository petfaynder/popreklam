        ...
        <div className="space-y-6">
            ...
            <SectionHeader icon={User} iconColor={iconColors.profile} title="Profile Information" desc="Update your personal details" d={d}>
                <form onSubmit={handleProfileSubmit} className="space-y-4">
                    <div className="grid md:grid-cols-2 gap-4">
                        ...
                        <div><label className={labelCls}>{t('company')}</label><input type="text" value={profileData.company} onChange={e => setProfileData({ ...profileData, company: e.target.value })} className={inputCls} placeholder="Tech Blog Inc." /></div>
            ...
            <SectionHeader icon={Lock} iconColor={iconColors.password} title="Change Password" desc="Update your account password" d={d}>
                <form onSubmit={handlePasswordSubmit} className="space-y-4">
                    <div><label className={labelCls}>{t('currentPassword')}</label><input type="password" value={passwordData.currentPassword} onChange={e => setPasswordData({ ...passwordData, currentPassword: e.target.value })} className={inputCls} required /></div>
                    <div className="grid md:grid-cols-2 gap-4">
                        <div><label className={labelCls}>{t('newPassword')}</label><input type="password" value={passwordData.newPassword} onChange={e => setPasswordData({ ...passwordData, newPassword: e.target.value })} className={inputCls} required /></div>
