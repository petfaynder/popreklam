...
export default function PublisherLayout({ children }) {
    const t = useTranslations('publisher.nav');
                        ...
                        <div className="flex items-center gap-4 px-6 py-3.5">
                            ...
                            {!resendSent && (
                                ...
                                >
                                    ...
                                    {resendLoading ? tVerify('sending') : tVerify('resend')}
                                </button>
                            )}
                ...
                <header className={d.topbar}>
                    ...
                    <div className={`hidden md:block ${d.breadcrumb}`}>
                        {t('dashboard')} &gt; <span className={d.breadcrumbActive}>
                            {pathname === '/publisher' ? t('dashboard') : pathname.split('/').pop()?.charAt(0).toUpperCase() + pathname.split('/').pop()?.slice(1)}
                        </span>
                    </div>
                    ...
                    <div className="flex items-center gap-4 md:gap-6 ml-auto">
                        ...
                        <div className={d.balanceCard}>
                            <div className="text-right">
                                <div className={d.balanceLabel}>{tCommon('amount')}</div>
