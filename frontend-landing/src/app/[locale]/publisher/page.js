        ...
        <div className="space-y-8">
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    ...
                    <p className={d.subheading}>{t('subtitle')}</p>
                </div>
                <div className="flex items-center gap-3">
                    ...
                    <button onClick={exportData} className={`${d.btnSecondary} flex items-center gap-2`}>
                        ...
                        <span className="text-sm font-medium">{tCommon('exportCsv')}</span>
                    </button>
                    <button
                    ...
                    >
                        ...
                        <span className="text-sm">{t('addSite')}</span>
                    </button>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className={d.card}>
                    <h3 className={`text-lg font-bold mb-4 ${d.isDark ? 'text-white' : 'text-[#1A1A1A]'}`}>{t('earningsChart')}</h3>
                    {revenueTrends ? (
                        <LineChart
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className={`${d.card} lg:col-span-2`}>
                    <h3 className={`text-lg font-bold mb-4 ${d.isDark ? 'text-white' : 'text-[#1A1A1A]'}`}>{t('topSites')}</h3>
                    ...
                    {deviceStats ? (
                        deviceStats.devices && deviceStats.devices.length > 0 ? (
                            ...
                            <div className="h-[260px] flex flex-col items-center justify-center gap-3">
                                ...
                                <p className={`text-sm ${d.isDark ? 'text-gray-500' : 'text-gray-400'}`}>{tCommon('noData')}</p>
                                <p className={`text-xs ${d.isDark ? 'text-gray-600' : 'text-gray-300'}`}>{tCommon('noData')}</p>
                            </div>
                        )
                    ) : (
                        <div className="h-[260px] flex items-center justify-center">
