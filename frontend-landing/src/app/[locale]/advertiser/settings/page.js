        ...
        <div className="space-y-6">
            ...
            <SectionCard icon={User} iconCls={iconCls.profile} title="Profile Information" desc="Update your name, email, and company" d={d}>
                <form onSubmit={handleProfile} className="space-y-4">
                    ...
                    <div><label className={labelCls}>{t('company')}</label><input type="text" value={profileData.company} onChange={e => setProfileData({ ...profileData, company: e.target.value })} className={inputCls} placeholder="Acme Inc." /></div>
            ...
            <SectionCard icon={CreditCard} iconCls={iconCls.billing} title="Billing Information" desc="Company and invoice details" d={d}>
                <form onSubmit={handleBilling} className="space-y-4">
                    <div className="grid md:grid-cols-2 gap-4">
                        <div><label className={labelCls}>{t('company')}</label><input type="text" value={billingData.companyName} onChange={e => setBillingData({ ...billingData, companyName: e.target.value })} className={inputCls} placeholder="Acme Inc." /></div>
