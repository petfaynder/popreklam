...
-- AlterTable
ALTER TABLE `campaigns` ADD COLUMN `cpm_rate` DECIMAL(10, 2) NOT NULL DEFAULT 2.0;

-- AlterTable
ALTER TABLE `impressions` ADD COLUMN `publisher_revenue` DECIMAL(10, 5) NOT NULL DEFAULT 0,
    ADD COLUMN `system_profit` DECIMAL(10, 5) NOT NULL DEFAULT 0;
