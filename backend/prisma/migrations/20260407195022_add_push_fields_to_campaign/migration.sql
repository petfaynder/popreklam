...
-- AlterTable
ALTER TABLE `campaigns` ADD COLUMN `push_body` VARCHAR(140) NULL,
    ADD COLUMN `push_icon` TEXT NULL,
    ADD COLUMN `push_image` TEXT NULL,
    ADD COLUMN `push_title` VARCHAR(60) NULL;
