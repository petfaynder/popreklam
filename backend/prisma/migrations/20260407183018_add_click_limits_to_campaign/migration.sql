...
-- AlterTable
ALTER TABLE `campaigns` ADD COLUMN `daily_clicks` INTEGER NOT NULL DEFAULT 0,
    ADD COLUMN `daily_clicks_limit` INTEGER NULL,
    ADD COLUMN `total_clicks_limit` INTEGER NULL;
