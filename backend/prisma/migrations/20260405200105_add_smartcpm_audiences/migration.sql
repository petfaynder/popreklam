...
-- AlterTable
ALTER TABLE `campaigns` ADD COLUMN `bidding_strategy` ENUM('CPM', 'SMART_CPM', 'SMART_CPC') NOT NULL DEFAULT 'CPM',
    ADD COLUMN `smart_cpm_max_bid` DECIMAL(10, 4) NULL;
...
CREATE TABLE `audiences` (
    ...
    INDEX `audiences_advertiser_id_idx`(`advertiser_id`),
    INDEX `audiences_is_active_idx`(`is_active`),
    PRIMARY KEY (`id`)
